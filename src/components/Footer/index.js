              ...
              <div className={style.container}>
                <div>
                  <div className="mb-3">
                    <div className={style.logo}>
                      ...
                      <div className={style.name}>Sellpixels.com</div>
                    </div>
                  </div>
                  <div>
                    Copyright © {new Date().getFullYear()} Sellpixels.com |{" "}
                    <a
                  ...
                  <div className="mb-1">
                    <a
                      href="mailto:support@sellpixels.com"
                      className="vb__link"
                    >
                ...
                <div className={style.ratingWrapper}>
                  ...
                  >
                    ...
                    Based on feedback from Themeforest customers
                    <meta itemProp="bestRating" content="5" />
                    <meta itemProp="ratingValue" content="4.57" />
                    <meta itemProp="ratingCount" content="56" />
                    <meta
                      itemProp="itemReviewed"
                      content="Visual Builder Admin Template"
                    />
                  </div>
                </div>
              </div>
